...
enum AppLanguage: String, CaseIterable, Identifiable {
    ...
    fileprivate static let tableEn: [String: String] = [
        ...
        "usage.context": "Context: %1$@ / %2$@",
        "price.unknown": "(price unknown for this model)",
        "relay.price": "(relay price)",
        "msg.copy": "Copy",
        "msg.copied": "Copied",
        "quote.ask": "Quote & Ask",
        "quick.send": "Send to New Chat",
        "quick.open": "Open Main Window",
        "quick.sent": "Sent to a new chat",
        "vision.override.title": "Send images to this model?",
        "vision.override.message": "%@ is not recognized as a vision model. Images will normally be ignored. You can override this.",
        "vision.override.once": "Send images this time",
        "vision.override.always": "Always allow for this model",
        "vision.override.without": "Send without images",
        "vision.overrides": "Vision Overrides",
        "vision.overrides.footer": "These models always receive image parts even when their name looks text-only.",
        "msg.edit": "Edit",
        ...
        "folder.share.enable": "Enable Shared Context",
        "folder.share.disable": "Disable Shared Context",
        ...
        "account.default.name": "Your account",
        "account.username": "Username",
        "account.username.hint": "This name is stored locally and used for your account display.",
        "account.choose.avatar": "Choose Avatar…",
        "account.remove.avatar": "Remove Avatar",
        "account.avatar.hint": "Choose a local image. It is stored inside the app profile.",
        ...
        "context.section": "Context Window",
        "context.window": "Override (0 = auto)",
        "context.window.help": "Leave 0 to use relay metadata when available, otherwise a built-in estimate.",
        "context.window.footer": "Used only for the usage gauge; it is not sent to the model.",
        "search.section": "Web Search",
        "search.provider": "Search Backend",
        "search.api.key": "Search API Key",
        "search.endpoint": "SearXNG Endpoint",
        "search.endpoint.help": "Base URL of a self-hosted SearXNG instance with JSON output enabled.",
        "search.order": "Fallback order (top = tried first)",
        "agent.question.title": "Needs your input",
        "agent.question.answered": "Answered",
        "agent.question.placeholder": "Type another answer…",
        "agent.question.send": "Send",
        ...
        "summary.copy": "Copy",
        "summary.refresh": "Regenerate",
        "summary.empty": "No summary has been generated for this conversation yet.",
        "summary.failed": "Failed to generate summary",
        "search.footer": "Brave, Serper and Tavily need their own API key. Auto tries whichever key you provide, then falls back to public scraping.",
    ...
    fileprivate static let tableZhHans: [String: String] = [
        ...
        "quick.open": "打开主窗口",
        "quick.sent": "已发送到新会话",
        "vision.override.title": "要向该模型发送图片吗？",
        "vision.override.message": "%@ 没有被识别为视觉模型，图片通常会被忽略。你可以手动覆盖。",
        "vision.override.once": "本次仍然发送图片",
        "vision.override.always": "该模型总是允许图片",
        "vision.override.without": "不带图片发送",
        "vision.overrides": "视觉模型覆盖",
        "vision.overrides.footer": "列表中的模型即使名称看起来不支持视觉，也会强制发送图片。",
        "msg.edit": "编辑",
        ...
        "folder.share.enable": "开启共享上下文",
        "folder.share.disable": "关闭共享上下文",
        ...
        "account.details": "详细信息",
        "account.default.name": "你的账户",
        "account.username": "用户名",
        "account.username.hint": "名称仅保存在本地，用于显示账户信息。",
        "account.choose.avatar": "选择头像…",
        "account.remove.avatar": "移除头像",
        "account.avatar.hint": "选择本地图片，图片会存储在应用账户资料中。",
        ...
        "api.key": "API 密钥",
        "generation": "生成",
        "context.section": "上下文窗口",
        "context.window": "手动覆盖（0 = 自动）",
        "context.window.help": "填 0 时优先使用中继返回的模型元数据，否则使用内置估算。",
        "context.window.footer": "仅用于底部用量条显示，不会发送给模型。",
        "search.section": "网络搜索",
        "search.provider": "搜索后端",
        "search.api.key": "搜索 API Key",
        "search.endpoint": "SearXNG 地址",
        "search.endpoint.help": "自建 SearXNG 实例的基础 URL，需开启 JSON 输出。",
        "search.order": "回退顺序（越靠上越优先）",
        "agent.question.title": "需要你确认",
        "agent.question.answered": "已回答",
        "agent.question.placeholder": "输入其他答案…",
        "agent.question.send": "发送",
        ...
        "summary.stale": "内容已更新",
        "summary.copy": "复制",
        "summary.refresh": "重新生成",
        "summary.empty": "该会话还没有生成摘要。",
        "summary.failed": "生成摘要失败",
        "search.footer": "Brave / Serper / Tavily 需要各自申请 API Key；Auto 会尝试你填写的 Key，失败时退回公开网页抓取。",
