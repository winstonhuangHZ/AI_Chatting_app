...
enum AppLanguage: String, CaseIterable, Identifiable {
    ...
    fileprivate static let tableEn: [String: String] = [
        ...
        "kb.generate.message": "Name this block so the assistant can fetch it later (e.g. “account info”). Its stored content = this conversation.",
    ...
    fileprivate static let tableZhHans: [String: String] = [
        ...
        "kb.generate.message": "给这个个性化块起个名字，方便以后让助手按名字读取（例如「账户信息」）。块内容 = 本段对话。",
